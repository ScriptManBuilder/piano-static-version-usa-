...
const Products: React.FC = () => {
  ...
  const categories = useMemo(() => [
    ...
    { id: 'Piano Basics', name: 'Piano Basics' },
    { id: 'Piano Fundamentals', name: 'Piano Fundamentals' },
  ...
  return (
    <ProductsWrapper>
      <Container>
        <PageHeader>
          <PageTitle>Piano Course Collection</PageTitle>
          <PageSubtitle>Master piano playing with our comprehensive music fundamentals and advanced piano technique video library</PageSubtitle>
        </PageHeader>
