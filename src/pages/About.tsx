  ...
  return (
    <AboutWrapper>
      <HeroSection ref={heroRef}>
        ...
        <LogoContainer>
          <MainLogo>PIANO COURSES</MainLogo>
        </LogoContainer>
        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('PIANO COURSES')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower musicians worldwide with professional piano education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform musical concepts into practical piano playing skills.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted piano courses cover music theory, piano techniques, classical pieces, popular songs, and musical composition. Each course is designed with hands-on practice, real-world applications, and professional techniques to help you master piano and advance your career in the music industry.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our Piano Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive piano learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                ...
                <LeaderInfo>
                  ...
                  <LeaderTitle>Piano Experts & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about piano music and dedicated to making piano education accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the art of piano playing.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in Piano Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in piano education, constantly updating 
                  our curriculum with the latest piano techniques and musical best practices.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  Piano should be accessible to everyone. We create a supportive environment 
                  where musicians from all backgrounds can master musical fundamentals.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern Piano Techniques</ValueTitle>
                <ValueDescription>
                  We stay current with the latest piano methods and musical tools, 
                  bringing modern musical practices directly to our students.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(32)}>
                <ValueIcon>🛡️</ValueIcon>
                <ValueTitle>Musical Performance Principles</ValueTitle>
                <ValueDescription>
                  We prioritize teaching clean, professional performance techniques, not just how to 
                  play pieces, but how to play them efficiently and professionally.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  Piano is an evolving art. We foster continuous learning 
              ...
              <ValueCard ref={setElementRef(34)}>
                ...
                <ValueDescription>
                  We focus on practical piano skills that you can apply immediately 
                  in real performances, from classical pieces to modern songs and composition.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(35)}>
              ...
              <MissionStatementText>
                To empower the next generation of musicians with world-class education, 
                practical skills, and real-world performances that drive musical career success. 
                We believe that by making piano education accessible and excellent, we can help 
                students create beautiful musical performances while creating opportunities for everyone 
                to participate in the musical revolution.
              </MissionStatementText>
            </MissionStatement>
          </ValuesContainer>
        </Container>
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            ...
            <ModalSubtitle>Piano Education Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional piano experts is dedicated to 
            transforming musical careers through comprehensive piano education.
            <br /><br />
            We believe piano should be accessible to everyone, from complete beginners to advanced musicians looking to 
            refine their skills. That's why we created comprehensive video courses that break down complex piano concepts 
            into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of piano music and empower them 
            with the knowledge and skills needed to create beautiful musical performances and advance their musical careers. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately.
            <br /><br />
            Whether you're just starting your piano journey or looking to master advanced musical techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of piano together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
