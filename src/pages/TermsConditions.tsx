    ...
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          the terms and provisions of this agreement. These terms apply to all digital piano courses, educational content, and 
      ...
      <Section>
        ...
        <Paragraph>
          This piano course platform is operated by {COMPANY_INFO.name}. 
      ...
      <Section>
        <SectionTitle>3. Digital Piano Course Pricing</SectionTitle>
        <Paragraph>
          Our piano courses are available at the following price points: {formatPrice(6.99)}, {formatPrice(9.99)}, {formatPrice(19.99)}, {formatPrice(29.99)}, {formatPrice(39.99)}, {formatPrice(49.99)}, {formatPrice(59.99)}, {formatPrice(69.99)}, {formatPrice(79.99)}, {formatPrice(89.99)}, and {formatPrice(99.99)}. 
      ...
      <Section>
        ...
        <Paragraph>
          We accept major credit and debit cards for piano course purchases. Your payment information is processed securely through our payment processors using 256-bit SSL encryption.
        </Paragraph>
        <Paragraph>
          <strong>Billing Descriptor:</strong> Charges will appear on your credit card statement as "PIANO COURSES" or "PIANOVA.LESSONS". 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased piano courses through your account dashboard. 
      ...
      <Section>
        ...
        <Paragraph>
          All piano course content, including videos, text, images, and downloadable materials, are the intellectual property of 
      ...
      <Section>
        ...
        <Paragraph>
          Due to the digital nature of our piano courses, all sales are final. However, we offer a 7-day satisfaction guarantee. 
      ...
      <Section>
        ...
        <Paragraph>
          We continuously update our piano course content to reflect the latest developments in music education and piano techniques. 
      ...
      <Section>
        ...
        <Paragraph>
          {COMPANY_INFO.name} provides piano courses for educational purposes only. We make no guarantees about 
