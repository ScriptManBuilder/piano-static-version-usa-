  ...
  return (
    <FooterWrapper>
      <FooterContent>
        <FooterMain>
          <FooterSection>
            ...
            <ul>
              ...
              <li><Link to="/products">Piano Courses</Link></li>
          ...
          <MoreAboutSection>
            ...
            <PromoCards>
              <PromoCard href="/products">
                <img src="/images/img_1.jpg" alt="Piano Courses" />
                <PromoCardContent>
                  <h4>Music Courses</h4>
                  <p>Piano Lessons</p>
                </PromoCardContent>
        ...
        <FooterBottom>
          <Copyright>
            Copyright  2025 {COMPANY_INFO.name}. All rights reserved. | Premium Piano Education & Musical Learning Courses
          </Copyright>
        </FooterBottom>
      </FooterContent>
    </FooterWrapper>
